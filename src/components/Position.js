...
const Position = () => {
  ...
  const [imageOpacity, setImageOpacity] = useState(0); // Initialize opacity state
  ...
  const handleChange = (index) => {
    ...
    setImageOpacity(0); // Start with 0 opacity
    setTimeout(() => {
      setImageOpacity(1); // Set opacity to 1 after a short delay
    }, 100); // Adjust the delay (in milliseconds) as needed
    console.log("Opacity:", imageOpacity);
  };
    ...
    <>
      <div className="w-full h-screen bg-gray-900 relative">
        <div className="flex text-center   max-h-[900px] py-60 justify-center gap-10">
          <div className="bg-gray-800 flex items-center justify-around rounded-2xl w-[700px] aspect-square px-16">
            ...
            <div className="max-w-[200px] text-gray-200 text-left">
          ...
          <div className="relative bg-gray-500 w-[800px] rounded-2xl flex justify-center items-center gap-7">
            <div className="opacity-50 bg-gradient-to-tr from-gray-300 via-orange-400 to-orange-700 w-[50px] aspect-square rounded-full absolute z-10 right-5 top-5"></div>
